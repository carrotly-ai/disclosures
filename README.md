...
| `CompanyInsiders` | "Who runs it?" — directors, officers, titles, and 10%+ owners from insider registers. | US, GB (incl. ECCTA identity status), KR, TW, DE (MAR Art. 19), CN (SZSE structured 董监高 share-change feed; SSE annual-report 董监高 roster — partial) |
